...
public class Logindetail implements Serializable {
	...
	private BigDecimal numberofinvalidattempts;
...
//	private Userdetail userdetail1;
	...
	@OneToOne(cascade=CascadeType.ALL, fetch=FetchType.EAGER) /*(mappedBy="logindetail")*/
	@JoinColumn(name="ACCOUNTNUMBER")
	...
	public BigDecimal getNumberofinvalidattempts() {
		return this.numberofinvalidattempts;
	}

	public void setNumberofinvalidattempts(BigDecimal numberofinvalidattempts) {
